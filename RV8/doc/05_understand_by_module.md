...
## ทุกส่วนต่อกันอย่างไร:

```
┌─────────────────────────────────────────────────────────────┐
│                                                              │
│  U1-U8 (574×8)     U12-U13 (283×2)    U16-U17 (574×2)     │
│  [กล่องเก็บเลข]     [เครื่องบวก]         [ตัวชี้ PC]         │
│       ↕                ↓                   ↕                │
│  ═══ IBUS (สายภายใน 8 เส้น) ═══    ═══ สาย ADDRESS ═══     │
│       ↕                                    ↕                │
│  U22 (245)                            U18-U19 (574×2)       │
│  [สะพาน]                              [ตัวจำที่อยู่]         │
│       ↕                                                     │
│  ═══ RV8-Bus (สายภายนอก 40 ขา) ═══════════════════════════  │
│       ↕                                                     │
│  ROM + RAM (หน่วยความจำ)                                     │
│                                                              │
│  U23+U27 (Flash×2) + U26 (161) + U24 (74) + U20+U21 (138×2)│
│  [สมอง — อ่าน opcode+step+flags แล้วสั่งทุกส่วน]            │
└─────────────────────────────────────────────────────────────┘
```

### กฎสำคัญ:
- **IBUS**: มีคนพูดได้ทีละ 1 คนเท่านั้น (ควบคุมโดย /OE)
- **สาย ADDRESS**: PC ขับ หรือ address latch ขับ (ไม่เคยพร้อมกัน)
- **สะพาน U22**: เปิดเฉพาะตอนอ่าน/เขียน memory
